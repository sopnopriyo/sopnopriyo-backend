package com.sopnopriyo.application.config;
...
public class CacheConfiguration implements DisposableBean {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("sopnopriyo");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("sopnopriyo");
        ...
        config.getMapConfigs().put("com.sopnopriyo.application.domain.*", initializeDomainMapConfig(jHipsterProperties));
